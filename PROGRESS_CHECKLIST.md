...
| Submodule                       | Tasks                                                                                                           |
| ------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| **Payment Vouchers**            | [x] Model: `PaymentVoucher` (serial prefix `PV-`) — ✅ Enhanced on 2025-11-06 with Phase 2 improvements <br>[x] Added exchange_rate, is_on_hold, GL integration fields — ✅ Completed on 2025-11-06 <br>[x] Payment method changed to enum (matching PaymentReceipt) — ✅ Completed on 2025-11-06 <br>[x] Added allocation tracking (allocated_amount, unallocated_amount) — ✅ Completed on 2025-11-06 <br>[x] PaymentVoucherAllocation model for tracking payments to invoices — ✅ Completed on 2025-11-06 <br>[x] Business methods: allocateToInvoice, isFullyAllocated, recalculateAllocations — ✅ Completed on 2025-11-06 <br>[x] Filament Resource: Approval workflow — ✅ Completed on 2025-11-04 <br>[x] Actions: CreatePaymentVoucher, ApprovePaymentVoucher, RecordPayment — ✅ Completed on 2025-11-04 |
