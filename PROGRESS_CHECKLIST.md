...
| **Supplier Invoices**          | [x] `SupplierInvoice` model — ✅ Model and migration created (2025-11-06) <br>[x] Link PO + GRN — ✅ Relationships implemented (2025-11-03) <br>[x] Tax & currency handling — ✅ Fields and calculations implemented (2025-11-03) <br>[x] Create migration for supplier invoice tables — ✅ Completed (2025-11-06) <br>[ ] Create Filament Resource for Supplier Invoices                                                          |
| **Three-way Matching**         | [x] Create migration for invoice matching table — ✅ Completed (2025-11-06) <br>[x] `InvoiceMatching` model — ✅ Enhanced with status constants and validation (2025-11-06) <br>[x] Automated validation: PO vs GRN vs Invoice totals — ✅ ValidateThreeWayMatch action implemented (2025-11-06) <br>[x] Report mismatches — ✅ Detailed mismatch reporting with item-level validation (2025-11-06) <br>[x] Block invoice approval if mismatch exceeds tolerance — ✅ Implemented shouldBlockApproval() method (2025-11-06) <br>[x] Compare PO quantities with GRN quantities — ✅ Item-level quantity validation (2025-11-06) <br>[x] Compare PO prices with invoice prices — ✅ Item-level price validation (2025-11-06) <br>[x] Calculate variance amounts — ✅ Quantity and price variance calculation (2025-11-06) <br>[x] Generate match report with discrepancies — ✅ Comprehensive reporting via getMatchingReport() (2025-11-06) <br>[x] Comprehensive test suite — ✅ 11 tests covering all scenarios (2025-11-06) <br>[ ] Create Filament Resource for Invoice Matching                            |
