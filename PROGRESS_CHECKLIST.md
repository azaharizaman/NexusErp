...
| Submodule                      | Tasks                                                                                                                                      |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| **Goods Received Notes (GRN)** | [x] `GRN` model — ✅ Model and migration created (2025-11-06) <br>[x] Linked to PO — ✅ Relationship implemented (2025-11-03) <br>[x] Capture delivered quantity, batch, date — ✅ Fields defined in model (2025-11-03) <br>[ ] Auto-update stock if inventory package exists — ⏳ Awaiting inventory package <br>[x] Create migration for GRN tables — ✅ Completed (2025-11-06) <br>[ ] Create Filament Resource for GRN |
| **Supplier Invoices**          | [x] `SupplierInvoice` model — ✅ Completed with GL & AP integration (2025-11-06) <br>[x] `SupplierInvoiceItem` model — ✅ Completed with expense_account_id (2025-11-06) <br>[x] Link PO + GRN — ✅ Relationships implemented (2025-11-03) <br>[x] Tax & currency handling — ✅ Fields and calculations implemented (2025-11-03) <br>[x] GL Integration — ✅ Fields and relationships added (2025-11-06) <br>[x] Create migrations for supplier invoice tables — ✅ Completed (2025-11-06) <br>[x] Create comprehensive unit tests — ✅ 14 tests passing (2025-11-06) <br>[ ] Create Filament Resource for Supplier Invoices — ⏳ Pending UI implementation |
| **Three-way Matching**         | [x] Create migration for invoice matching table — ✅ Completed (2025-11-06) <br>[x] `InvoiceMatching` model — ✅ Enhanced with status constants and validation (2025-11-06) <br>[x] Automated validation: PO vs GRN vs Invoice totals — ✅ ValidateThreeWayMatch action implemented (2025-11-06) <br>[x] Report mismatches — ✅ Detailed mismatch reporting with item-level validation (2025-11-06) <br>[x] Block invoice approval if mismatch exceeds tolerance — ✅ Implemented shouldBlockApproval() method (2025-11-06) <br>[x] Comprehensive test suite — ✅ 11 tests covering all scenarios (2025-11-06) <br>[ ] Create Filament Resource for Invoice Matching — ⏳ Future enhancement |
| **Debit / Credit Notes**       | [x] `SupplierDebitNote` model — ✅ Completed with GL integration (2025-11-06) <br>[x] Allow linking to Invoice and Vendor account — ✅ Relationships implemented (2025-11-06) <br>[x] GL Integration — ✅ Fields and relationships added (2025-11-06) <br>[x] Create migrations for debit note table — ✅ Completed (2025-11-06) <br>[x] Unit tests — ✅ 20 tests created (2025-11-06) <br>[ ] Create Filament Resource for Debit Notes — ⏳ Pending UI implementation |
...
| **Payment Processing**         | [x] `PaymentVoucher` model — ✅ Completed with allocation tracking (2025-11-06) <br>[x] Payment allocation to invoices — ✅ allocateToInvoice() method implemented (2025-11-06) <br>[x] Multiple payment methods support — ✅ Enum values defined (2025-11-06) <br>[x] On-hold functionality — ✅ is_on_hold flag and related fields (2025-11-06) <br>[x] Payment voucher allocations — ✅ PaymentVoucherAllocation model (2025-11-06) <br>[x] Comprehensive unit tests — ✅ 20 tests passing (2025-11-06) |
| **Testing & Documentation**    | [x] Unit tests for PaymentVoucher — ✅ 20 tests covering allocation, status checks, scopes (2025-11-06) <br>[x] Unit tests for SupplierDebitNote — ✅ 20 tests covering application, validation, scopes (2025-11-06) <br>[x] Feature tests for GL posting actions — ✅ PostPaymentVoucher, PostSupplierDebitNote, PostSupplierInvoice (2025-11-06) <br>[x] Feature tests for three-way matching — ✅ ValidateThreeWayMatch action tests (2025-11-06) <br>[x] AP module documentation — ✅ Comprehensive docs/accounts-payable.md created (2025-11-06) <br>[x] Architectural decisions documentation — ✅ Phase 8 added to ARCHITECTURAL_DECISIONS.md (2025-11-06) <br>[x] Progress checklist updates — ✅ Phase 8 marked as complete (2025-11-06) <br>[ ] Additional feature tests for approval workflows — ⏳ Future enhancement |
